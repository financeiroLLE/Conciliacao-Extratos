...
def tela_resultado():
    ...
    if not st.session_state.banco_conta_selecionada:
        # v5.13: Resumo Executivo no estilo Opção A (cards generosos)
        # As funções editoriais ficam no código mas não são chamadas.
        render_resumo_executivo_opcao_a(resultado, kpis)
